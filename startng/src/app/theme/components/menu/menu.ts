...
export const verticalMenuItems = [ 
    new Menu (3, 'Factures ', null, null, 'file-text', null, true, 0),   
    new Menu (4, 'Listes des factures', null, null, 'th-list', null, true, 3),  
    new Menu (5, 'Dossier Facture ', '/pages/ui/cards',null, 'folder-o', null, false, 3), 
    new Menu (6, 'Par Date', '/pages/ui/components', null,null, null, false, 4),
    new Menu (7, 'Par Fournisseur', '/pages/ui/icons', null, null, null, false, 4), 
  ...
  //  new Menu (9, 'Media Objects', '/pages/ui/media-objects', null, 'object-group', null, false, 3), 
   ...
   // new Menu (11, 'Typography', '/pages/ui/typography', null, 'font', null, false, 3),
    new Menu (20, 'Fournisseurs', null, null, 'users', null, true, 0), 
    new Menu (21, 'Listes Des Fournisseurs ', null, null, 'list-ul', null, true, 20),
    new Menu (22, 'par Statut', '/pages/form-elements/layouts', null, null, null, false, 21),
    new Menu (23, 'Par contact', '/pages/form-elements/validations', null, null, null, false, 21),
   // new Menu (24, 'Form Wizard', '/pages/form-elements/wizard', null, 'magic', null, false, 20),
    new Menu (25, "ajout au carnet d'adresse", '/pages/form-elements/editor', null, 'address-book', null, false, 20),
    new Menu (26, 'Adminstration', null, null, 'wrench', null, true, 0),
     new Menu (27, "Gestion d'application", '/pages/tables/basic-tables', null, 'gears', null, false, 26), 
     new Menu (28, 'Connexion Serveur', null, null, 'server', null, false, 26),
